...
@section('main')
    <main>
        ...
        <div class="comic-blue-bar">
            <div class="comic cover wrapper">
                <div class="pic-container">
                    <img src="{{ config('comics.1.thumb') }}" alt="DC Banner">
                </div>
            </div>
        </div>
        {{-- /Blue bar with comic --}}
        ...
        <div class="comic wrapper">
            ...
            <div class="board row">
                <div class="col-9">
                    <h2 class="text-uppercase pb-3 fw-bold">{{ config('comics.1.title') }}</h2>
                    <div class="info-bar row">
                        <div class="col-9 d-flex justify-content-between align-items-center">
                            <div class="price">
                                <span class="currency"> U.S. Price:</span>
                                <span>{{ config('comics.1.price') }}</span>
                    ...
                    <p>{{ config('comics.1.description') }}</p>
                </div>
                <div class="col-3">
                    <div class="pic-container">
                ...
                <div class="top-infos row">
                    ...
                    <div class="custom-col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9 text-uppercase"><a href="#">{{ config('comics.1.series') }}</a></div>
                        </div>
                        <div class="row">
                            <div class="col-3">U.S. Price:</div>
                            <div class="col-9">{{ config('comics.1.price') }}</div>
                        </div>
                        <div class="row">
                            <div class="col-3">On Sale Date:</div>
                            <div class="col-9">{{ \Carbon\Carbon::parse(config('comics.1.sale_date'))->format('M d Y') }}
                            </div>
                        </div>
                    </div>
                </div>
