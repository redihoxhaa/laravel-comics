...
@section('main')
    <main>
        ...
        <div class="comic wrapper">
            ...
            <div class="board row">
                <div class="col-9">
                    <h2 class="text-uppercase">{{ config('comics.0.title') }}</h2>
                ...
                <div class="top-infos row">
                    ...
                    <div class="custom-col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">{{ config('comics.0.sale_date') }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bottom-infos row">
            <div class="wrapper">
                ...
                <div class="col-3 d-flex justify-content-between">
                    ...
                    <div class="pic-container">
                        <img src="{{ Vite::asset('resources/img/buy-comics-merchandise.png') }}" alt="Subscriptions icon">
                    </div>
                </div>
            </div>
        </div>
